$(function(){
    ...
    */
    $parentElement.find('.action-reset-layout-options').on('click', function() {
		...
		$('.main-wrap > .navigation .navbar')
			.removeClass('navbar-default navbar-inverse navbar-primary navbar-success navbar-info navbar-warning navbar-danger navbar-softpurple navbar-lightingyellow')
    ...
    */
	...
	var sidebarPossibleClasses =
		'sidebar-dark-primary sidebar-dark-info sidebar-dark-success sidebar-dark-warning sidebar-dark-danger sidebar-dark-softpurple sidebar-dark-lightingyellow ' +
		'sidebar-light-primary sidebar-light-info sidebar-light-success sidebar-light-warning sidebar-light-danger sidebar-light-softpurple sidebar-light-lightingyellow ' +
		'sidebar-primary sidebar-info sidebar-success sidebar-warning sidebar-danger sidebar-softpurple sidebar-lightingyellow';

	var navbarPossibleClasses =
		'navbar-inverse navbar-default navbar-primary navbar-success navbar-info navbar-warning navbar-danger navbar-lightingyellow navbar-softpurple';
	...
	$parentElement.find('[name=mainColor],[name=navbarStyle],[name=sidebarStyle]')
		...
		.on('load-handler', function() {
			...
			var bodyClasses = (function() {
				...
				return needsDefault ? startupBodyClasses.concat(['sidebar-dark-warning'])
					: startupBodyClasses;
			})();
